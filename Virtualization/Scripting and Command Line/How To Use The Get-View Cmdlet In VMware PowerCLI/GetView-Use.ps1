...
Write-Output "PowerCLI   : $((Get-Module -Name VMware.PowerCLI -ListAvailable).Version)"
...
# API Reference https://code.vmware.com/apis/358/vsphere
#endregion
