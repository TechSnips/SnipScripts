...
$ebApp = New-EBApplication -ApplicationName 'AutomateBoring'
...
Compress-Archive -Path 'C:\MyPackageFolder\*' -DestinationPath 'C:\package.zip'

## Create an S3 bucket if one doesn't already exist
New-S3Bucket -BucketName 'techsnips'

## Upload the package to S3
Write-S3Object -BucketName 'techsnips' -File 'C:\package.zip'
...
$newVerParams = @{
      ...
      SourceBundle_S3Bucket = 'techsnips'
